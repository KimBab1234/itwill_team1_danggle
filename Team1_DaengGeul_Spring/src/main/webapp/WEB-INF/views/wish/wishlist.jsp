		...
		<table border="1" style="width: 1300px; text-align: center; margin-top: 20px">
			...
			<c:forEach var="wishlist" items="${wishlist }">
				<tr>				
					...
					<td><a href="ProductDetail.go?product_idx=${wishlist.product_idx }"><img src="${pageContext.request.contextPath }/resources/img/product/${wishlist.product_real_img}" width="130px" height="130px" style="object-fit: cover;"></a></td>
