        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="${pageContext.request.contextPath }/resources/img/g2.PNG" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">굿즈</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="${pageContext.request.contextPath }/resources/img/g3.PNG" alt="">
                    </a>
        ...
        <div class="row px-xl-5">
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary2 text-center text-md-right text-white mb-2 py-5 px-5">
                    <img src="${pageContext.request.contextPath }/resources/img/ha.jpg" alt="">
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary2 text-center text-md-left text-white mb-2 py-5 px-5">
                    <img src="${pageContext.request.contextPath }/resources/img/doc.jpg" alt="">
                    <div class="position-relative" style="z-index: 1;">
            ...
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    <div class="vendor-item border p-4">
                        <img src="${pageContext.request.contextPath }/resources/img/kyobo.png" width="120px" height="120px" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="${pageContext.request.contextPath }/resources/img/yp.png" width="120px" height="120px" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="${pageContext.request.contextPath }/resources/img/yes24.png" width="120px" height="120px" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="${pageContext.request.contextPath }/resources/img/aladin.png" width="120px" height="120px" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="${pageContext.request.contextPath }/resources/img/interpark.png" width="120px" height="120px" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="${pageContext.request.contextPath }/resources/img/amazon.png" width="120px" height="60px" alt="">
                    </div>
                </div>
            </div>
        </div>
