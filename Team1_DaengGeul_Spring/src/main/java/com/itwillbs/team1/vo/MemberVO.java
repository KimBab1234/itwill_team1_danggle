...
public class MemberVO {
	...
	public void setMember_phone(String member_phone) {
		...
		member_phone1 = phone[0];
		member_phone2 = phone[1];
		member_phone3 = phone[2];
	}
	...
	public void setMember_email(String member_email) {
		...
		member_email1 = email[0];
		member_email2 = email[1];
	...
	public String toString() {
		return "MemberVO [member_id=" + member_id + ", member_passwd=" + member_passwd + ", member_name=" + member_name
				+ ", member_phone=" + member_phone + ", member_phone1=" + member_phone1 + ", member_phone2="
				+ member_phone2 + ", member_phone3=" + member_phone3 + ", member_email=" + member_email
				+ ", member_email1=" + member_email1 + ", member_email2=" + member_email2 + ", member_postcode="
				+ member_postcode + ", member_roadAddress=" + member_roadAddress + ", member_jibunAddress="
				+ member_jibunAddress + ", member_addressDetail=" + member_addressDetail + ", member_join_date="
				+ member_join_date + ", member_gender=" + member_gender + ", member_point=" + member_point
				+ ", member_coupon=" + member_coupon + ", member_authStatus=" + member_authStatus + "]";
	}
