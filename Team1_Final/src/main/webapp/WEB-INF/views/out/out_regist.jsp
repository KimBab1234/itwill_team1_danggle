...
<body>
	<div style="width:900px;">
		<div class="title_regi">출고예정입력</div>
		<form action="#" method="post" name="proRegi" style="width:600px;">
			<table class="regi_table">
				...
				<tr>
					...
					<th>거래처</th>
					<td>
						<input type="text" class="acc_code" id="acc_code" name="acc_code" placeholder="거래처 코드" ondblclick="window.open('AccSearch', 'searchPopup', 'width=500, height=500, left=600, top=400')">
						<input type="text" class="acc_name" id="acc_name" name="acc_name" placeholder="거래처명" ondblclick="window.open('AccSearch', 'searchPopup', 'width=500, height=500, left=600, top=400')">
