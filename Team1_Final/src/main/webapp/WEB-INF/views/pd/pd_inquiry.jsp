...
// 			$("#listForm > table").append(boardList);
			...
			for(let product of pdList2) {
				...
				let result = "<tr height='100'>"
							...
							+ "<td>" + product.PRODUCT_GROUP_BOTTOM_CD + '|' + product.PRODUCT_GROUP_BOTTOM_NAME + "</td>"
...
// 							+ "<td>" + product.PRODUCT_IMAGE + "</td>"
							+ "<td>" + "<img width='100px' height='150px' src='https://itwill220823team1.s3.ap-northeast-2.amazonaws.com/profileImg/" + product.PRODUCT_IMAGE + "'></td>"
